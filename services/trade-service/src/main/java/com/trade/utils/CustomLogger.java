...
public class CustomLogger {
    ...
    private String appName = "Trader-Service";
    ...
    public void setLogger() throws Exception {
        ...
        loggerConfig = Logger.getLogger("TradeCustomLogger");

        loggerConfig.setUseParentHandlers(false);

        ConsoleHandler handler = new ConsoleHandler();
        handler.setFormatter(new JsonLikeLogFormatter());  
    ...
    private static class JsonLikeLogFormatter extends Formatter {
        ...
        public String format(LogRecord record) {
            ...
            return String.format(
                    ...
                    "\"machineIP\": \"%s\", \"timestamp\": \"%s\", \"message\": \"%s\",\"stackTrace\"\"%s\" }\n",
                    record.getLevel(),
                    p[0],
                    p[1],
                    p[2],
